...
export function LinkManager() {
  ...
  async function refreshLink(linkId: string) {
    recordUiAction({ action: 'links.refresh', resourceId: linkId });
  ...
  return (
    <div className="link-manager">
      <div className="link-manager-header">
        ...
        <Button size="small" onClick={() => { recordUiAction({ action: 'links.refresh', metadata: { scope: 'list' } }); void loadLinks(); }}>Refresh</Button>
      </div>
